...
class OrdremissionSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        model = Ordremission
        fields = ['id','user','objetmission', 'datedepart', 'dateretour', 'adressemission', 'transport', 'adressehebergement', 'adresseemploye', 'signatureemployeur', 'createdat', 'fichier_an_one', 'fichier_an_two', 'fichier_genere', 'is_evoiyer','prenom', 'nom','datecreat','is_signer']        